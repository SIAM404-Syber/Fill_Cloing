...
def banner():
 ...
 __  ___  __   _  _    .__   __.   _______         _______.__   _  _    .___  ___. 
|  |/  / /_ | | || |   |  \ |  |  /  _____|       /       /_ | | || |   |   \/   | 
|  '  /   | | | || |_  |   \|  | |  |  __        |   (----`| | | || |_  |  \  /  | 
|    <    | | |__   _| |  . `  | |  | |_ |        \   \    | | |__   _| |  |\/|  | 
|  .  \   | |    | |   |  |\   | |  |__| |    .----)   |   | |    | |   |  |  |  | 
|__|\__\  |_|    |_|   |__| \__|  \______|    |_______/    |_|    |_|   |__|  |__|
                               
                                

                      
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAminul Islam
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801319913395
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mXaiko Siam
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCiihP-K8UIMqOy-0kQXJb4Q")
		exit()
	else:
		os.system("https://youtube.com/channel/UCiihP-K8UIMqOy-0kQXJb4Q")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open https://youtube.com/channel/UCiihP-K8UIMqOy-0kQXJb4Q")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [SIAM] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [SIAM-CP] %s|%s        '%(b,idf,pw))
